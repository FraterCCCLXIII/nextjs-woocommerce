  ...
  return (
    <Layout title="Returns & Refunds">
      <Head>
        ...
        <meta
          name="description"
          content="Learn about Molecule's returns and refunds policy for research peptides and compounds."
        />
      </Head>
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-12">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                Due to our rigorous quality control standards and the fragile
                nature of our products, we cannot accept returns. However, if
                your order arrives with missing, incorrect, or damaged items, we
                are here to help. Please email{' '}
                <a
